...
+--------+------------+-------------------+--------------+---------------+--------------+----------------------------------------------------------------+
| Branch | Schedule   | Release Manager   |  Status      | First release | End-of-life  | Comment                                                        |
+========+============+===================+==============+===============+==============+================================================================+
| master | :pep:`537` | Ned Deily         |  features    | *2018-06-15*  | *2023-06-15* | The default branch is currently the future version Python 3.7. |
+--------+------------+-------------------+--------------+---------------+--------------+----------------------------------------------------------------+
| 3.6    | :pep:`494` | Ned Deily         |  bugfix      | 2016-12-23    | *2021-12-23* | `Most recent binary release: Python 3.6.1                      |
|        |            |                   |              |               |              | <https://www.python.org/downloads/release/python-361/>`_       |
+--------+------------+-------------------+--------------+---------------+--------------+----------------------------------------------------------------+
| 3.5    | :pep:`478` | Larry Hastings    |  bugfix      | 2015-09-13    | *2020-09-13* | `Most recent binary release: Python 3.5.3                      |
|        |            |                   |              |               |              | <https://www.python.org/downloads/release/python-353/>`_       |
+--------+------------+-------------------+--------------+---------------+--------------+----------------------------------------------------------------+
| 2.7    | :pep:`373` | Benjamin Peterson |  bugfix      | 2010-07-03    | *2020-01-01* | The support has been extended to 2020 (1).                     |
|        |            |                   |              |               |              | `Most recent binary release: Python 2.7.13                     |
|        |            |                   |              |               |              | <https://www.python.org/downloads/release/python-2713/>`_      |
+--------+------------+-------------------+--------------+---------------+--------------+----------------------------------------------------------------+
| 3.4    | :pep:`429` | Larry Hastings    |  security    | 2014-03-16    | *2019-03-16* | `Most recent security release: Python 3.4.6                    |
|        |            |                   |              |               |              | <https://www.python.org/downloads/release/python-346/>`_       |
+--------+------------+-------------------+--------------+---------------+--------------+----------------------------------------------------------------+
| 3.3    | :pep:`398` | Georg Brandl      |  security    | 2012-09-29    | *2017-09-29* | `Most recent security release: Python 3.3.6                    |
|        |            |                   |              |               |              | <https://www.python.org/downloads/release/python-336/>`_       |
+--------+------------+-------------------+--------------+---------------+--------------+----------------------------------------------------------------+
| 3.2    | :pep:`392` | Georg Brandl      |  end-of-life | 2011-02-20    | 2016-02-20   | `Final release: Python 3.2.6                                   |
|        |            |                   |              |               |              | <https://www.python.org/downloads/release/python-326/>`_       |
+--------+------------+-------------------+--------------+---------------+--------------+----------------------------------------------------------------+
| 3.1    | :pep:`375` | Benjamin Peterson |  end-of-life | 2009-06-27    | 2012-04-11   | `Final release: Python 3.1.5                                   |
|        |            |                   |              |               |              | <https://www.python.org/downloads/release/python-315/>`_       |
+--------+------------+-------------------+--------------+---------------+--------------+----------------------------------------------------------------+
| 3.0    | :pep:`361` | Barry Warsaw      |  end-of-life | 2008-12-03    | 2009-01-13   | `Final release: Python 3.0.1                                   |
|        |            |                   |              |               |              | <https://www.python.org/download/releases/3.0.1/>`_            |
+--------+------------+-------------------+--------------+---------------+--------------+----------------------------------------------------------------+
| 2.6    | :pep:`361` | Barry Warsaw      |  end-of-life | 2008-10-01    | 2013-10-29   | `Final release: Python 2.6.9                                   |
