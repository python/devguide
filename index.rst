...
+------------------+--------------+-------------+----------------+----------------+----------------------------------------------------------------------------+
| 3.4              | :pep:`429`   | security    | 2014-03-16     | *2019-03-16*   | `Latest binary release: Python 3.4.6                                       |
...
|                  |              |             |                |                | `Latest security release: Python 3.3.6                                     |
...
|                  |              |             |                |                | `Last security release: Python 3.2.6                                       |
|                  |              |             |                |                | <https://www.python.org/downloads/release/python-326/>`_                   |
+------------------+--------------+-------------+----------------+----------------+----------------------------------------------------------------------------+
| 3.1              | :pep:`375`   | end-of-life | 2009-06-27     | 2012-04-11     | `Last binary release: Python 3.1.4                                         |
|                  |              |             |                |                | <https://www.python.org/download/releases/3.1.4/>`_                        |
|                  |              |             |                |                | `Last security release: Python 3.1.5                                       |
|                  |              |             |                |                | <https://www.python.org/download/releases/3.1.5/>`_                        |
+------------------+--------------+-------------+----------------+----------------+----------------------------------------------------------------------------+
| 3.0              | :pep:`361`   | end-of-life | 2008-12-03     | 2009-01-13     | `Last binary release: Python 3.0.1                                         |
|                  |              |             |                |                | <https://www.python.org/download/releases/3.0.1/>`_                        |
+------------------+--------------+-------------+----------------+----------------+----------------------------------------------------------------------------+
| 2.6              | :pep:`361`   | end-of-life | 2008-10-01     | 2013-10-29     | `Last binary release: Python 2.6.6                                         |
|                  |              |             |                |                | <https://www.python.org/download/releases/2.6.6/>`_                        |
|                  |              |             |                |                | `Last security release: Python 2.6.9                                       |
