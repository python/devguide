...
* When your code isn't formatted correctly, :ref:`pre-commit <install-pre-commit>`
...
* Once all formatting errors have been fixed, you can push your work to your GitHub fork::
