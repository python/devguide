...
In 3.11, this mechanism has been replaced by a statically generated table, ``code->co_exceptiontable``, which
is described in detail in the
`internals documentation`<https://github.com/python/cpython/blob/main/InternalDocs/exception_handling.md>.
