...
+ Python/
    ...
    Python-ast.c
        ...
        marshalling code in :cpy-file:`asdl.c`).  "File automatically generated by
        :cpy-file:`Parser/asdl_c.py`".  This file must be committed separately
    ...
    asdl.c
        ...
        identifier.  Used by :cpy-file:`Python-ast.c` for marshalling AST nodes.
